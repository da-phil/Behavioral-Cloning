...
#
# Visualization taken from https://gist.github.com/hadim/9fedb72b54eb3bc453362274cd347a6a
#
...
if __name__ == "__main__":
    ...
    #outputFeatureMap(X_train, model.layers[1])
    _ = plot_feature_map(model, 1, X_train, 16)
    _ = plot_feature_map(model, 2, X_train, 32)
    _ = plot_feature_map(model, 4, X_train, 16)
    plt.show()
